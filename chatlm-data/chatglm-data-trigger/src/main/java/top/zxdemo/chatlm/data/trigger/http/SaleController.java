package top.zxdemo.chatlm.data.trigger.http;
...
import top.zxdemo.chatlm.data.trigger.http.dto.SaleProductDTO;
...
//    }
    ...
    public ResponseEntity<String> payNotify(
        ...
        try {
            ...
            // String total = total_fee;
            BigDecimal total = new BigDecimal(total_fee);
            String successTime = success_time;
            log.info("参数解析成功");
            // boolean isSuccess = orderService.changeOrderPaySuccess(orderId, transactionId, total.divide(new BigDecimal(100), 2, RoundingMode.HALF_UP), dateFormat.parse(successTime));
